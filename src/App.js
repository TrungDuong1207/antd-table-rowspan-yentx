...
//     let dataConvert = convertData(data2);
//     console.log({ dataConvert });
//     // setTimeout(() => {
//     //     dataConvert2 = convertData(data2);
//     // }, 300);

//     // useEffect(() => {
//     //     setDataConvert(dataConvert2)
//     // }, []);
...
function App() {
    const [dataTran, setDataTran] = useState(data2);
    console.log({ dataTran })
    // setTimeout(() => {
    //     setDataTran(data2)
    // }, 100)
    return <>{dataTran && <TableTest dataTran={dataTran} />}</>
}
